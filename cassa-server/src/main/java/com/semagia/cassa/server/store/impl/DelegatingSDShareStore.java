...
/**
 * {@link ISDShareStore} implementation which delegates all methods to an underlying
 * {@link ISDShareStore} instance.
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 */
public class DelegatingSDShareStore implements ISDShareStore {

    protected final ISDShareStore _store;

    public DelegatingSDShareStore(final ISDShareStore store) {
        if (store == null) {
    ...
    public long getLastModificationFragments(URI graphURI)
        ...
        return _store.getLastModificationFragments(graphURI);
    }
    ...
    public long getLastModificationSnapshots(URI graphURI)
            throws GraphNotExistsException, StoreException {
        return _store.getLastModificationSnapshots(graphURI);
    }
    ...
    public Iterable<IFragmentInfo> getFragments(URI graphURI)
            throws GraphNotExistsException, StoreException {
        return _store.getFragments(graphURI);
    }
    ...
    public Iterable<IFragmentInfo> getFragments(URI graphURI, long since)
            throws GraphNotExistsException, StoreException {
        return _store.getFragments(graphURI, since);
    }
    ...
    public Iterable<IGraphInfo> getSnapshots(URI graphURI)
            throws GraphNotExistsException, StoreException {
        return _store.getSnapshots(graphURI);
    }
